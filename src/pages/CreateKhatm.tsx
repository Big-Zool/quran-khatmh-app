...
const CreateKhatm: React.FC = () => {
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            setError(`${t('error')}: ${err.message || "Unknown error occurred"}`);
        } finally {
            setIsCreating(false);
        }
    };
                ...
                <div className="w-full max-w-[480px] bg-surface-light dark:bg-surface-dark shadow-[0_32px_64px_-12px_rgba(0,0,0,0.08)] dark:shadow-[0_32px_64px_-12px_rgba(0,0,0,0.3)] rounded-2xl transition-colors duration-300 border border-primary/5 dark:border-white/5 relative">
                    ...
                    <div className="p-8 flex flex-col gap-8">
                        ...
                        <div className="flex flex-col gap-2 text-start">
                            <span className="text-primary text-sm font-semibold tracking-wider uppercase opacity-80">{t('intention')}</span>
                        ...
                        <div className="flex flex-col gap-6">
                            <label className="group flex flex-col gap-3">
                                <span className="text-text-main dark:text-gray-200 text-base font-medium">{t('forWho')}</span>
                                <div className="relative">
                                    <input
                                        ...
                                        placeholder={t('khatmNamePlaceholder')}
                                        type="text"
                                        value={khatmName}
                                        onChange={(e) => {
                                    ...
                                    />
                                    <div className="absolute ltr:right-4 rtl:left-4 top-1/2 -translate-y-1/2 text-primary opacity-0 group-focus-within:opacity-100 transition-opacity duration-300 pointer-events-none">
                            ...
                            <div className="bg-primary/5 dark:bg-white/5 rounded-lg p-5 border border-primary/10 dark:border-white/5 flex gap-4 items-start">
                                ...
                                <div className="flex flex-col gap-1">
                                    <h4 className="text-sm font-bold text-text-main dark:text-white">{t('whatHappens')}</h4>
                        ...
                        <div className="pt-2">
                            ...
                            >
                                <span className="relative z-10 flex items-center justify-center gap-2">
                                    ...
                                    <span className="material-symbols-outlined transition-transform duration-300 group-hover:-translate-x-1 rtl:rotate-180">arrow_back</span>
                                </span>
